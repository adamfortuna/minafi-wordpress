...
'use strict';var _jquery=require('../components/jquery/dist/jquery');var _jquery2=_interopRequireDefault(_jquery);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}window.jQuery=window.$=_jquery2.default;function toggleSearch(e){var $searchInput=(0,_jquery2.default)('#searchInput');if($searchInput.val().length>0){// Do nothing and let the submission continue
}else{e.preventDefault();var $this=(0,_jquery2.default)(this);// Not showing form
if((0,_jquery2.default)('.search--link').hasClass('nav-link')){(0,_jquery2.default)('#searchInput').blur();}else{// Showing form
setTimeout(function(){(0,_jquery2.default)('#searchInput').focus();},1000);}$this.closest('.nav-item').toggleClass('search--searching');}}(0,_jquery2.default)(function(){(0,_jquery2.default)('.search--link').on('click',toggleSearch);});

},{"../components/jquery/dist/jquery":1}]},{},[2]);
