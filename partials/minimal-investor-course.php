<form action="//minafi.us16.list-manage.com/subscribe/post?u=d2476f8b6bf5aa45f4014a563&amp;id=704b6324f7" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" novalidate target="_blank">
  ...
  <div class="email--toggle" style="display: none;">
    <div class="form-group">
    	<input type="text" placeholder="Your first name" value="" name="FNAME" class="email form-control form-control-sm">
    </div>
  </div>
  ...
  <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_d2476f8b6bf5aa45f4014a563_704b6324f7" tabindex="-1" value=""></div>

  <div class="group">
		<button type="submit" name="subscribe" id="mc-embedded-subscribe" class="btn btn-sm btn-success">Subscribe</button>
	</div>
</form>
