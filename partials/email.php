<form action="https://www.getdrip.com/forms/719052090/submissions" method="post" data-drip-embedded-form="719052090">
  <h3 data-drip-attribute="headlines">Minafi Newletter</h3>
  <p><small data-drip-attribute="descriptions">Investing, minimalism, mindfulness and FI delivered <b>right to your inbox</b>!</small></p>
  ...
  <div class="email--toggle mb-2" style="display: none;">
    ...
    <div class="mt-2">
      <input type="radio" name="fields[subscription]" value="all" id="email--subscription-all" checked="checked" /> <label for="email--subscription-all"><small>All Articles &amp; Monthly Newsletter</small></label>
      <br/>
